...
# Script to run paper_revision.py in final mode with Anthropic model
...
# Using claude-3-sonnet instead of claude-opus to avoid token limit issues
echo -e "\033[1;34m[INFO]\033[0m Running paper_revision.py in final mode with Anthropic model..."
python paper_revision.py --mode final --provider anthropic --model "claude-3-sonnet-20240229" < temp_inputs.txt
